package jp.ac.it_college.std.s20020.cloudvision004
...
import jp.ac.it_college.std.s20020.cloudvision004.databinding.ActivityMainBinding
import java.io.ByteArrayOutputStream


private const val TAG = "CloudVsion"
            ...
            auth.signInWithEmailAndPassword("s20020@std.it-college.ac.jp", "taiga6666")
                .addOnCompleteListener(this) { task ->
                    if (task.isSuccessful) {
                        ...
                        Log.d(TAG, "signInWithEmail: login failure")
                    }
                }
        }
